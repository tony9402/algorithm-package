...
int build_balanced(int l, int r, vector<int> &left_child,
...
vector<int> inorder(int root, const vector<int> &left_child,
...
vector<int> postorder(int root, const vector<int> &left_child,
                      const vector<int> &right_child) {
  vector<int> result;
...
void generate_balanced(int minN, int maxN) {
  int n = rnd.next(minN, maxN);
  vector<int> left_child(n + 1), right_child(n + 1);
  int root = build_balanced(1, n, left_child, right_child);
